...
initial begin
 ...
 for (int i = 0; i < 112; i = i + 1) begin
 delta_data[i] = 16'h0000;
 end

 // Group information data
 group_info[0] = 16'h0fa2;
 group_info[1] = 16'h1773;
 group_info[2] = 16'h7d9b;
 group_info[3] = 16'h0037;
 group_info[4] = 16'h0010;
 group_info[5] = 16'h0007;
 group_info[6] = 16'h0000;
 group_info[7] = 16'h8000;
 group_info[8] = 16'h0000;
 group_info[9] = 16'h0000;
 group_info[10] = 16'h3e88;
 group_info[11] = 16'h4268;
 group_info[12] = 16'h6507;
 group_info[13] = 16'h08a3;
 group_info[14] = 16'h0020;
 group_info[15] = 16'h0009;
 group_info[16] = 16'h0008;
 group_info[17] = 16'h8000;
 ...
 group_info[24] = 16'h0009;
 group_info[25] = 16'h0000;
 group_info[26] = 16'h0018;
 group_info[27] = 16'h8000;
 ...
 delta_data[96] = 16'h0000;
 delta_data[97] = 16'h0001;
