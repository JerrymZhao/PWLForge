// Auto-generated bit width definitions for exp
// Generated using 16-bit aligned memory layout with power-of-two optimization

`ifndef exp_OPTIMIZED_BITWIDTHS_VH
`define exp_OPTIMIZED_BITWIDTHS_VH

// Common parameters
`define OPT_FRAC_BITS 10
`define OPT_SCALE_FACTOR 1024
`define OPT_NUM_GROUPS 11
`define OPT_TOTAL_INTERVALS 96
...
`define OPT_TOTAL_GROUP_BITS 1760
`define OPT_TOTAL_DELTA_BITS 6144
`define OPT_TOTAL_MEMORY_BITS 7904
`define OPT_TOTAL_MEMORY_BYTES 988

`endif // exp_OPTIMIZED_BITWIDTHS_VH
