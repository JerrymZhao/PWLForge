...
//==============================================================================
// Floating-Point Greater-Than-or-Equal Comparison Wrapper (NonBlocking Mode)
//
// Description:
...
// - Operation Selection: Greater_Than_or_Equal
// - Flow Control: NonBlocking
// - Latency: 2 cycles
//==============================================================================

module fp_compare_ge_wrapper #(
    ...
    // Input operand B (interval_start)
